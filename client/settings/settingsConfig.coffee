...
module.exports = ($stateProvider, templateProvider, translateProvider) ->
  ...
  $stateProvider
    ...
    .state "home.settings.configurations", url: "/settings/configurations", controller: "configurationController as configCtrl", template: templateProvider.provide "configurationsView"
