...
module.exports = (files) ->
  ...
  top.svg["ng-class"] = "[(x.stencil.position.side || 'pcb-side'), (x.stencil.style.lay ? 'stencil-layout' : 'stencil-centered')]"
  outline.path["ng-class"] = "x.stencil.style.out ? 'stencil-outline' : 'stencil-no-outline'"
  figs.push outline
  top: gerberToSvg top
